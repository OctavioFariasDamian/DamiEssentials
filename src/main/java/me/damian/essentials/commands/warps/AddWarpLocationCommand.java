...
public class AddWarpLocationCommand implements TabExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if(args.length == 0){
            sendMessageWithPrefix(sender, "&cEl uso del comando es: /addwarplocation <nombre>", WarpsManager.prefix);
            return false;
        }
        ...
        sendMessageWithPrefix(sender, "&fAñadiste una nueva localización al warp &e"+name+"&f.", WarpsManager.prefix);
        warp.save();
        return false;
    }
