...
public class SetWarpPriceCommand implements TabExecutor {
    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if(args.length < 2){
            sendMessageWithPrefix(sender, "&cEl uso del comando es: /setwarpprice <nombre> <precio>", WarpsManager.prefix);
            return false;
        }
        ...
        try{
            ...
            sendMessageWithPrefix(sender, "&cPrecio inválido.", WarpsManager.prefix);
            return false;
        }
        ...
        sendMessageWithPrefix(sender, "&fCambiaste el precio del warp &e"+name+"&f a &e"+price, WarpsManager.prefix);
        warp.save();
        return false;
    }
